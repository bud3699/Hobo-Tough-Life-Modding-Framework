...
namespace HoboModPlugin.Framework
{
    ...
    /// <summary>
    /// Avatar override definition - replace full NPC models with custom characters
    /// Uses the Avatar Retargeting system to inject custom prefabs from AssetBundles
    /// </summary>
    public class AvatarOverrideDefinition
    {
        /// <summary>
        /// Target mesh name to replace (the SkinnedMeshRenderer.sharedMesh.name of the NPC)
        /// E.g., "Hobo_Majsner_Mesh"
        /// </summary>
        [JsonProperty("target")]
        public string Target { get; set; } = "";
